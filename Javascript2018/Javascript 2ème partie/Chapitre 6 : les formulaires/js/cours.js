//-----------------------------------------ZONE DE TEXTE---------------------------------------------------------------------------------
//Accéder à la valeur saisie  avec  la propriété .value
var pseudoElt = document.getElementById("pseudo");
pseudoElt.value = "MonPseudo";

// Affichage d'un message contextuel pour la saisie du pseudo lorsqu'on clique sur une zone de texte (focus)
pseudoElt.addEventListener("focus", function () {
    document.getElementById("aidePseudo").textContent = "Entrez votre pseudo";
});
// Suppression du message contextuel pour la saisie du pseudo lorsqu'on change de cible (blur) et qu'on quitte le précédant focus
...
// Affichage du type d'abonnement choisi  (boutons radios)
...
// Affichage du code de nationalité choisi  (listes déroulantes)
...
form.addEventListener("submit", function (e) {
    ...
    if (form.elements.confirmation.checked) {//pour une checkbox -->  name.checked
    ...
    switch (form.elements.abonnement.value) {//pour un type radio  -->  name.value
    case "abonewspromo":
    ...
    switch (form.elements.nationalite.value) {//pour un select  --> name.value
    case "FR":
...
//-------------VALIDATION EN FIN DE SAISIE -->  FIN DE FOCUS  =  blur
