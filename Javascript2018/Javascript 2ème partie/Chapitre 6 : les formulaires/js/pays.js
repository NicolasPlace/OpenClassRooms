...
var paysElt = document.querySelector("input");//récupère  la saisie dans l'input
var suggestionsElt = document.getElementById("suggestions");//récupère la div  avec pour id suggestions
...
paysElt.addEventListener("input", function () {
    ...
    listePays.forEach(function (pays) {//on parcourt la liste des pays
