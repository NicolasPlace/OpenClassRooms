...
var langagesElt = document.getElementById("langages");

function afficher(reponse) {
    var virgule = ";";
    splitElt = reponse.split(virgule);
    for(i = 0 ; i < splitElt.length ; i++){
      var liElt = document.createElement("li");
      liElt.textContent = splitElt[i];
      langagesElt.appendChild(liElt);
    }
}
